...
% corrVals_BATCH = cell2table(cell(0,0));
...
% Generating VS1 and ES1 (REF)
    ...
    results_BATCH.OptimalLambda(k) = optimalLambda;
...
for k = 1:numel(growth_conditions)
    ...
    results_CHEM_S.OptimalLambda(k) = optimalLambda;
...
for k = 1:numel(growth_conditions)
    ...
    results_CHEM_V.OptimalLambda(k) = optimalLambda;
...
for k = 1:numel(growth_conditions)
    ...
    results_CHEM_P.OptimalLambda(k) = optimalLambda;
